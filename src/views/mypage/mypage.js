...
window.onload = async function () {
  ...
  if (role === 'admin') {
    ...
    const urls = ['/admin/category/list', '/admin/product/list', '/admin/cart/list'];
    const img_urls = ['./mypage-img/category.gif', './mypage-img/product.gif', './mypage-img/order.gif'];
  ...
  // 사용자가 일반 회원이면 보여줄 버튼들
    ...
    const img_urls = ['./mypage-img/user-info.gif', './mypage-img/order.gif'];
